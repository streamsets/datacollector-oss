...
`dist/target/streamsets-datacollector-1.7.0.0-SNAPSHOT/streamsets-datacollector-1.7.0.0-SNAPSHOT/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-1.7.0.0-SNAPSHOT/streamsets-datacollector-1.7.0.0-SNAPSHOT/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-1.7.0.0-SNAPSHOT.tgz`

Untar the tarball in your prefered location :

`tar xvzf streamsets-datacollector-all-1.7.0.0-SNAPSHOT.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-1.7.0.0-SNAPSHOT/bin/streamsets dc`
