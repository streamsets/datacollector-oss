...
`dist/target/streamsets-datacollector-1.6.0.0/streamsets-datacollector-1.6.0.0/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-1.6.0.0/streamsets-datacollector-1.6.0.0/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-1.6.0.0.tgz`

Untar the tarball in your prefered location :

`tar xvzf streamsets-datacollector-all-1.6.0.0.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-1.6.0.0/bin/streamsets dc`
