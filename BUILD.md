...
`release/target/streamsets-datacollector-all-3.19.0-SNAPSHOT-CATALOG.tgz`

Extract the tarball to your preferred location :

`tar xf streamsets-datacollector-all-3.19.0-SNAPSHOT-CATALOG.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-3.19.0-SNAPSHOT-CATALOG/bin/streamsets dc`
