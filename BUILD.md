...
`dist/target/streamsets-datacollector-3.18.0-SNAPSHOT/streamsets-datacollector-3.18.0-SNAPSHOT/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-3.18.0-SNAPSHOT/streamsets-datacollector-3.18.0-SNAPSHOT/bin/streamsets cli`
