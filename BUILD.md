...
`dist/target/streamsets-datacollector-2.5.0.0-0001/streamsets-datacollector-2.5.0.0-0001/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-2.5.0.0-0001/streamsets-datacollector-2.5.0.0-0001/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-2.5.0.0-0001.tgz`

Untar the tarball in your prefered location :

`tar xvzf streamsets-datacollector-all-2.5.0.0-0001.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-2.5.0.0-0001/bin/streamsets dc`
