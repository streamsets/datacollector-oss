...
`dist/target/streamsets-datacollector-3.17.1-0030/streamsets-datacollector-3.17.1-0030/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-3.17.1-0030/streamsets-datacollector-3.17.1-0030/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-3.17.1-0030.tgz`

Extract the tarball to your preferred location :

`tar xf streamsets-datacollector-all-3.17.1-0030.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-3.17.1-0030/bin/streamsets dc`
