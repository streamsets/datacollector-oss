...
`dist/target/streamsets-datacollector-2.5.0.0/streamsets-datacollector-2.5.0.0/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-2.5.0.0/streamsets-datacollector-2.5.0.0/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-2.5.0.0.tgz`
...
`streamsets-datacollector-all-2.5.0.0/bin/streamsets dc`
