...
`dist/target/streamsets-datacollector-1.2.1.1-SNAPSHOT/streamsets-datacollector-1.2.1.1-SNAPSHOT/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-1.2.1.1-SNAPSHOT/streamsets-datacollector-1.2.1.1-SNAPSHOT/bin/streamsets cli`
...
`release/target/tar/streamsets-datacollector-1.2.1.1-SNAPSHOT.tgz`

Untar the tarball in your prefered location :

`tar xvzf streamsets-datacollector-1.2.1.1-SNAPSHOT.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-1.2.1.1-SNAPSHOT/bin/streamsets dc`
