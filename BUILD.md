...
`dist/target/streamsets-datacollector-2.3.0.1/streamsets-datacollector-2.3.0.1/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-2.3.0.1/streamsets-datacollector-2.3.0.1/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-2.3.0.1.tgz`

Untar the tarball in your prefered location :

`tar xvzf streamsets-datacollector-all-2.3.0.1.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-2.3.0.1/bin/streamsets dc`
