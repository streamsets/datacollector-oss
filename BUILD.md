...
`dist/target/streamsets-datacollector-3.1.2.0-SNAPSHOT/streamsets-datacollector-3.1.2.0-SNAPSHOT/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-3.1.2.0-SNAPSHOT/streamsets-datacollector-3.1.2.0-SNAPSHOT/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-3.1.2.0-SNAPSHOT.tgz`

Extract the tarball to your preferred location :

`tar xf streamsets-datacollector-all-3.1.2.0-SNAPSHOT.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-3.1.2.0-SNAPSHOT/bin/streamsets dc`
