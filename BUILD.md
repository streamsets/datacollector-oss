...
`dist/target/streamsets-datacollector-3.21.0/streamsets-datacollector-3.21.0/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-3.21.0-CATALOG.tgz`

Extract the tarball to your preferred location :

`tar xf streamsets-datacollector-all-3.21.0-CATALOG.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-3.21.0-CATALOG/bin/streamsets dc`

Extract the tarball to your preferred location :

`tar xf streamsets-datacollector-all-3.21.0.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-3.21.0/bin/streamsets dc`
