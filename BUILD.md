...
`dist/target/streamsets-datacollector-2.4.1.0/streamsets-datacollector-2.4.1.0/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-2.4.1.0/streamsets-datacollector-2.4.1.0/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-2.4.1.0.tgz`

Untar the tarball in your prefered location :

`tar xvzf streamsets-datacollector-all-2.4.1.0.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-2.4.1.0/bin/streamsets dc`
