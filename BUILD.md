...
`dist/target/streamsets-datacollector-2.7.0.0/streamsets-datacollector-2.7.0.0/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-2.7.0.0/streamsets-datacollector-2.7.0.0/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-2.7.0.0.tgz`

Extract the tarball to your preferred location :

`tar xf streamsets-datacollector-all-2.7.0.0.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-2.7.0.0/bin/streamsets dc`
