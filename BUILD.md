...
`dist/target/streamsets-datacollector-2.6.0.1-SNAPSHOT/streamsets-datacollector-2.6.0.1-SNAPSHOT/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-2.6.0.1-SNAPSHOT/streamsets-datacollector-2.6.0.1-SNAPSHOT/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-2.6.0.1-SNAPSHOT.tgz`

Extract the tarball to your preferred location :

`tar xf streamsets-datacollector-all-2.6.0.1-SNAPSHOT.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-2.6.0.1-SNAPSHOT/bin/streamsets dc`
