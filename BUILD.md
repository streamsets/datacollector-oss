...
`dist/target/streamsets-datacollector-3.15.0-0027/streamsets-datacollector-3.15.0-0027/bin/streamsets dc`

For Data Collector CLI, execute:

`dist/target/streamsets-datacollector-3.15.0-0027/streamsets-datacollector-3.15.0-0027/bin/streamsets cli`
...
`release/target/streamsets-datacollector-all-3.15.0-0027.tgz`

Extract the tarball to your preferred location :

`tar xf streamsets-datacollector-all-3.15.0-0027.tgz`

To start the DataCollector, execute:

`streamsets-datacollector-all-3.15.0-0027/bin/streamsets dc`
