...
public class AmazonS3SourceUpgraderTest {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/AmazonS3DSource.yaml");
  ...
  public void testV11toV12FirstEmptyCredentials() throws StageException {
    configs.add(new Config("s3ConfigBean.s3Config.awsConfig.awsAccessKeyId", ""));
    configs.add(new Config("s3ConfigBean.s3Config.awsConfig.awsSecretAccessKey", "foo"));
    testV11toV12("WITH_CREDENTIALS");
  }

  @Test
  public void testV11toV12SecondEmptyCredentials() throws StageException {
    configs.add(new Config("s3ConfigBean.s3Config.awsConfig.awsAccessKeyId", "foo"));
    configs.add(new Config("s3ConfigBean.s3Config.awsConfig.awsSecretAccessKey", ""));
    testV11toV12("WITH_CREDENTIALS");
  }
  ...
  public void testV11toV12NoneEmptyCredentials() throws StageException {
    configs.add(new Config("s3ConfigBean.s3Config.awsConfig.awsAccessKeyId", "foo"));
    configs.add(new Config("s3ConfigBean.s3Config.awsConfig.awsSecretAccessKey", "bar"));
    testV11toV12("WITH_CREDENTIALS");
  }
  ...
  private void testV11toV12(String expectedCredentialsMode) throws StageException {
    ...
    UpgraderTestUtils.assertExists(configs, "s3ConfigBean.s3Config.usePathAddressModel", true);
    UpgraderTestUtils.assertExists(configs, "s3ConfigBean.s3Config.awsConfig.credentialMode", expectedCredentialsMode);
  }
}
