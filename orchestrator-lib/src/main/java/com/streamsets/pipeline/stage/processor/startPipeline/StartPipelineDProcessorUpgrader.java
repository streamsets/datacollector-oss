...
import com.streamsets.pipeline.stage.origin.startPipeline.StartPipelineDSourceUpgrader;

import java.util.List;

public class StartPipelineDProcessorUpgrader implements StageUpgrader {

  @Override
  public List<Config> upgrade(List<Config> configs, Context context) throws StageException {
    switch(context.getFromVersion()) {
      case 1:
        StartPipelineDSourceUpgrader.upgradeV1ToV2(configs);
        break;
      default:
