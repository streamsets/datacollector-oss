...
public class TestWaitForJobCompletionProcessorUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/WaitForJobCompletionDProcessor.yaml");
