...
public class TestStartJobDProcessorUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/StartJobDProcessor.yaml");
    upgrader = new SelectorStageUpgrader("stage", new StartJobDProcessorUpgrader(), yamlResource);
