...
public class TestSparkStreamingSource {
  ...
  public void setup() throws Exception {
    ...
    File pipelineFile = null; // TODO we need a pipline json file, it should have a source of
    ...
    EmbeddedPipeline pipeline = new EmbeddedPipeline("SIMPLE_PIPELINE", "admin", "tag1", "what is this?",
      pipelineConfigBean);
  ...
  public void test() throws Exception {
    ...
    long actual = EmbeddedSDC.getRecordsProducedJVMWide();
