...
fil["33"]= "Destinations/Flume.html@@@Flume@@@The Flume destination writes data to Flume...";
...
fil["54"]= "Install_Config/HTTP-RandomPortNo.html@@@Random Port Number@@@You can configure the Data Collector to use a random port number. By default, the Data Collector uses a static port number defined in the Data Collector properties file...";
...
fil["62"]= "Origins/FileTail.html@@@File Tail@@@File Tail logs information about file processing, such as a file name and time it started processing a file...";
...
fil["71"]= "Pipeline_Configuration/ErrorHandling.html@@@Error Record Handling@@@You can use a Directory or Kafka Consumer origin in a error pipeline to reprocess error record files. When you reprocess error record files, do not edit or rename the files. The origin expects the files as generated by the original pipeline...";
fil["72"]= "Pipeline_Configuration/PipelineConfiguration_title.html@@@Pipeline Configuration@@@...";
fil["73"]= "Pipeline_Configuration/PipelineDesign.html@@@Pipeline Design@@@Use the following information and tips when you invoke expression completion...";
fil["74"]= "Pipeline_Configuration/PipelineMemory.html@@@Pipeline Memory@@@The Data Collector uses memory when it runs a pipeline. To avoid causing out-of-memory errors on the host machine, you can configure the maximum amount of memory that can be used for the pipeline...";
fil["75"]= "Pipeline_Configuration/SDCRecordFormat.html@@@SDC Record Data Format@@@SDC Record is a proprietary data format that the Data Collector uses to generate error records. You can also configure a pipeline to read or write SDC Record dat...";
...
fil["89"]= "Pipeline_Monitoring/PipelineStageErrors.html@@@Pipeline and Stage Errors@@@When you monitor a pipeline, you can view error statistics for the pipeline and each stage. You can also view a sampling of the error records...";
...
fil["92"]= "Processors/ConfiguringExpressionsConditions.html@@@Configuring Expressions and Conditions@@@When you use a field name in an expression, use the following syntax...";
