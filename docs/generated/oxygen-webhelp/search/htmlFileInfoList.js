...
fil["62"]= "Origins/JDBCConsumer.html@@@JDBC Consumer@@@JDBC Consumer uses offset values in the offset column to determine where to continue processing after a deliberate or unexpected stop. To ensure seamless recovery, use a primary key or index column as the offset column...";
...
fil["68"]= "Origins/UDP.html@@@UDP Source@@@The UDP Source origin reads NetFlow messages from one or more UDP ports. UDP Source generates a record for every NetFlow message. UDP Source reads data from NetFlow Version 5...";
