...
fil["26"]= "Pipeline_Configuration/DataCollectorWindow-Config.html@@@Data Collector Window - Configuration Mode@@@The following image shows the pipeline configuration options for the Data Collector window: Area / Icon Name Description 1 Pipeline canvas Displays the pipeline. Use to configure the stages for the...";
fil["27"]= "Pipeline_Configuration/ErrorHandling.html@@@Error Handling@@@...";
...
fil["31"]= "Pipeline_Configuration/What_isa_Pipeline.html@@@What is a Pipeline?@@@A pipeline describes the stream of data for the Data Collector...";
...
fil["52"]= "Processors/Processors_overview.html@@@Processors@@@A required field must exist in a record to keep it in the pipeline. When a record does not include a required field, the processor drops the record. You can configure required fields for any processor stage...";
fil["53"]= "Processors/Processors_title.html@@@Processors@@@...";
fil["54"]= "Processors/StreamSelector.html@@@Stream Selector@@@Use a Stream Selector to route data to different streams...";
fil["55"]= "Troubleshooting/Troubleshooting.html@@@Troubleshooting@@@We hope the following troubleshooting tips might help you with any issues you might be having. If you have suggestions for additional troubleshooting items, please send them to docs@streamsets.com...";
fil["56"]= "Troubleshooting/Troubleshooting_title.html@@@Troubleshooting@@@...";
