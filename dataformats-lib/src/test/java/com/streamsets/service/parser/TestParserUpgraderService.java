...
public class TestParserUpgraderService {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/DataFormatParserUpgrader.yaml");
    upgrader = new SelectorStageUpgrader("stage", new ParserUpgrader(), yamlResource);
