...
public class KafkaOriginSinglePartitionIT extends PipelineOperationsClusterIT {
  ...
  public static void afterClass() throws Exception {
    ...
    PipelineOperationsClusterIT.afterClass("TestKafkaOriginSinglePartitionCluster");
  }
