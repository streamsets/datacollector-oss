 ...
 */
public class AvroWriteSupportInt96Avro18<T> extends WriteSupport<T> {

  private static final Logger LOG = LoggerFactory.getLogger(AvroWriteSupportInt96Avro18.class);
   ...
   */
  @Deprecated
  public AvroWriteSupportInt96Avro18(MessageType schema, Schema avroSchema) {
