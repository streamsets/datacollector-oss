...
import com.streamsets.pipeline.spark.AbstractStreamingBinding;
import com.streamsets.pipeline.spark.MapRStreamingBinding;
...
public class BootstrapClusterStreaming {
  ...
  public static void main(String[] args) throws Exception {
    AbstractStreamingBinding binding = null;
    try {
