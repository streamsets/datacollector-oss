...
public class CredentialDeploymentResponseJson {
  ...
  @JsonCreator
  public CredentialDeploymentResponseJson(
      @JsonProperty("sdcId") String sdcId,
      @JsonProperty("credentialDeploymentStatus") CredentialDeploymentStatus credentialDeploymentStatus
  ) {
    this.sdcId = sdcId;
  ...
  public CredentialDeploymentStatus getCredentialDeploymentStatus() {
    return credentialDeploymentStatus;
  }
}
