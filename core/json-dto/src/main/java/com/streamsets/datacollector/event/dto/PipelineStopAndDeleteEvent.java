...
public class PipelineStopAndDeleteEvent extends PipelineBaseEvent {
  ...
  public PipelineStopAndDeleteEvent() {
  }

  public void setForceTimeoutMillis(long forceTimeoutMillis) {
    this.forceTimeoutMillis = forceTimeoutMillis;
  }

  public long getForceTimeoutMillis() {
    return forceTimeoutMillis;
  }
}
