...
public class SupportBundleInjector implements Factory<SupportBundleManager> {
  ...
  @Inject
  public SupportBundleInjector(HttpServletRequest request) {
    supportBundleManager = (SupportBundleManager) request.getServletContext().getAttribute(SUPPORT_BUNDLE_MANAGER);
  }
