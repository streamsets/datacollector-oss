...
public class TestUtil1_0 {
  ...
  public static void addBrokerSslConfig(Properties props) {
    try {
      URL resource = TestUtil1_0.class.getClassLoader().getResource("server.keystore.jks");
      String serverKeystore = new File(resource.toURI()).getAbsolutePath();
      resource = TestUtil1_0.class.getClassLoader().getResource("server.truststore.jks");
  ...
  public static void addClientSslConfig(Map<String, Object> props) {
    try {
      URL resource = TestUtil1_0.class.getClassLoader().getResource("client.keystore.jks");
      String clientKeystore = new File(resource.toURI()).getAbsolutePath();
      resource = TestUtil1_0.class.getClassLoader().getResource("client.truststore.jks");
