...
public class TestUtil11 {
  ...
  public static void addBrokerSslConfig(Properties props) {
    try {
      URL resource = TestUtil11.class.getClassLoader().getResource("server.keystore.jks");
      String serverKeystore = new File(resource.toURI()).getAbsolutePath();
      resource = TestUtil11.class.getClassLoader().getResource("server.truststore.jks");
  ...
  public static void addClientSslConfig(Map<String, Object> props) {
    try {
      URL resource = TestUtil11.class.getClassLoader().getResource("client.keystore.jks");
      String clientKeystore = new File(resource.toURI()).getAbsolutePath();
      resource = TestUtil11.class.getClassLoader().getResource("client.truststore.jks");
