...
public class TestKafkaConsumer {
  ...
  public void testReadAfterKafkaShutdown() throws Exception {
    ...
    KafkaConsumer kafkaConsumer = new KafkaConsumer("testReadAfterZookeeperShutdown", 0, new KafkaBroker(HOST, port), 0, 8000,
  ...
  public void testGetOffsetAfterKafkaShutdown() throws Exception {
    ...
    KafkaConsumer kafkaConsumer = new KafkaConsumer("testGetOffsetAfterZookeeperShutdown", 0, new KafkaBroker(HOST, port), 0, 8000,
      2000, "testKafkaConsumer" + "_client");
    kafkaConsumer.init();
    //shutdown zookeeper server
    kafkaServer.shutdown();
  ...
  public void testReadInvalidOffset() throws Exception {
    ...
    KafkaConsumer kafkaConsumer = new KafkaConsumer("testReadInvalidOffset", 0, new KafkaBroker(HOST, port), 0, 8000,
      2000, "testKafkaConsumer" + "_client");
    kafkaConsumer.init();
  ...
  public void testReadValidOffset() throws Exception {
    ...
    KafkaConsumer kafkaConsumer = new KafkaConsumer("testReadValidOffset", 0, new KafkaBroker(HOST, port), 0, 8000,
      2000, "testKafkaConsumer" + "_client");
    kafkaConsumer.init();
    //attempt to read invalid offset
