...
public class HBaseProvider0_98 implements HBaseProvider {
  ...
  public HBaseProducer createProducer(
    ...
    return new HBaseProducer0_98(context, hBaseConnectionConfig, errorRecordHandler);
  }
  ...
  public HBaseProcessor createProcessor(
    ...
    return new HBaseProcessor0_98(context, new HBaseConnectionHelper0_98(), hBaseLookupConfig, errorRecordHandler);
  }
}
