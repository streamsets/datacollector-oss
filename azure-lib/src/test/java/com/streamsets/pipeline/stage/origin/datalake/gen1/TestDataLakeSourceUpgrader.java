...
public class TestDataLakeSourceUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/DataLakeDSource.yaml");
  ...
  public void testV1toV2() throws StageException {
    ...
    String dataFormatPrefix = "spoolDirConfig.dataFormatConfig.";
