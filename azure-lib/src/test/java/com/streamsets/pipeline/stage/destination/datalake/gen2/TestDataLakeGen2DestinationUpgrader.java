...
public class TestDataLakeGen2DestinationUpgrader {

  private StageUpgrader upgrader;
  private List<Config> configs;
  private StageUpgrader.Context context;

  private final String prefix = "dataLakeGen2TargetConfig.";

  @Before
  public void setUp() {
    upgrader = new SelectorStageUpgrader("stage", new DataLakeGen2TargetUpgrader(), null);
