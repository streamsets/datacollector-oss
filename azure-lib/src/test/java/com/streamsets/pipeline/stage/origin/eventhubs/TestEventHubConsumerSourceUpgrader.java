...
public class TestEventHubConsumerSourceUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/EventHubConsumerDSource.yaml");
  ...
  public void testV1toV2() throws StageException {
    ...
    String dataFormatPrefix = "consumerConfigBean.dataFormatConfig.";
