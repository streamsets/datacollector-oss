...
public class DataLakeMetadataExecutor extends HdfsMetadataExecutor {

  public DataLakeConnectionConfig dataLakeConnectionConfig;

  public DataLakeMetadataExecutor(DataLakeConnectionConfig dataLakeConnectionConfig, HdfsActionsConfig actions) {
