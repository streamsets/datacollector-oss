...
public class TestKafka10FactoriesBean {

  @Test
  public void testKafka09FactoriesBean() {
    Assert.assertTrue(FactoriesBean.getKafkaConsumerFactory() instanceof Kafka10ConsumerFactory);
