...
public class MaprJsonSourceUpgrader implements StageUpgrader {
  @Override
  ...
  private static void upgradeV1ToV2(List<Config> configs) {
    configs.add(new Config(MapRJsonOriginDSource.MAPR_JSON_ORIGIN_CONFIG_BEAN_PREFIX + "." + MapRJsonOriginConfigBean.JSON_MAX_OBJECT_LENGTH, 4096));
  }
}
