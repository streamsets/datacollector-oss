...
public class MapRJsonTargetUpgrader implements StageUpgrader {
  @Override
  ...
  private static void upgradeV1ToV2(List<Config> configs) {
    configs.add(new Config(MapRJsonConfigBean.MAPR_JSON_CONFIG_BEAN_PREFIX + ".setOrReplace", "REPLACE"));
  }
}
