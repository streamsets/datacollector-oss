...
public class TestDisconnectedLoginServlet {

  @Test
  public void testServlet() throws Exception {
    DisconnectedSSOService service = Mockito.mock(DisconnectedSSOService.class);
    DisconnectedLoginServlet servlet = new DisconnectedLoginServlet(service) {
      @Override
    ...
    Assert.assertEquals(DisconnectedLoginServlet.DISCONNECTED_LOGIN_HTML, servlet.getLoginPage());
