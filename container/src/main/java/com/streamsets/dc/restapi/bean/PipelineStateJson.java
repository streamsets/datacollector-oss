...
public class PipelineStateJson {
  ...
  public PipelineStateJson(
    ...
    pipelineState = new com.streamsets.dc.execution.manager.PipelineStateImpl(user, name, rev,
      BeanHelper.unwrapState(statusJson), message, timeStamp, attributes,
      BeanHelper.unwrapExecutionMode(executionModeJson));
  }

  public PipelineStateJson(com.streamsets.dc.execution.PipelineState pipelineState) {
  ...
  @JsonIgnore
  public com.streamsets.dc.execution.PipelineState getPipelineState() {
