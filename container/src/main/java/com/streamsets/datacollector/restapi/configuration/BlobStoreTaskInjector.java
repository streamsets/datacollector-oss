...
public class BlobStoreTaskInjector implements Factory<BlobStoreTask> {
  ...
  @Inject
  public BlobStoreTaskInjector(HttpServletRequest request) {
    blobStoreTask = (BlobStoreTask) request.getServletContext().getAttribute(BLOB_STORE_TASK);
  }
  ...
  @Override
  public void dispose(BlobStoreTask task) {
  }
}
