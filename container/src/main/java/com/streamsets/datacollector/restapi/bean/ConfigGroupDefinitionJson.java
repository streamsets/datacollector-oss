...
public class ConfigGroupDefinitionJson {
  ...
  private final com.streamsets.datacollector.config.ConfigGroupDefinition configGroupDefinition;

  public ConfigGroupDefinitionJson(com.streamsets.datacollector.config.ConfigGroupDefinition configGroupDefinition) {
