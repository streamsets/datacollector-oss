...
public class DataRuleDefinitionJson {
  ...
  private final com.streamsets.pipeline.config.DataRuleDefinition dataRuleDefinition;
  ...
  public DataRuleDefinitionJson(@JsonProperty("id") String id,
    ...
    this.dataRuleDefinition = new com.streamsets.pipeline.config.DataRuleDefinition(id, label, lane,
  ...
  public DataRuleDefinitionJson(com.streamsets.pipeline.config.DataRuleDefinition dataRuleDefinition) {
  ...
  @JsonIgnore
  public com.streamsets.pipeline.config.DataRuleDefinition getDataRuleDefinition() {
