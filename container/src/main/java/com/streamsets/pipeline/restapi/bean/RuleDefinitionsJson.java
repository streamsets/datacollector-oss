...
public class RuleDefinitionsJson {
  ...
  private final com.streamsets.pipeline.config.RuleDefinitions ruleDefinitions;
  ...
  public RuleDefinitionsJson(
    ...
    this.ruleDefinitions = new com.streamsets.pipeline.config.RuleDefinitions(
  ...
  public RuleDefinitionsJson(com.streamsets.pipeline.config.RuleDefinitions ruleDefinitions) {
  ...
  @JsonIgnore
  public com.streamsets.pipeline.config.RuleDefinitions getRuleDefinitions() {
