...
public class PipelineInfoJson {
  private final com.streamsets.pipeline.store.PipelineInfo pipelineInfo;
  ...
  public PipelineInfoJson(
    ...
    this.pipelineInfo = new com.streamsets.pipeline.store.PipelineInfo(name, description, created, lastModified,
      creator, lastModifier, lastRev, uuid, valid);
  }

  public PipelineInfoJson(com.streamsets.pipeline.store.PipelineInfo pipelineInfo) {
  ...
  @JsonIgnore
  public com.streamsets.pipeline.store.PipelineInfo getPipelineInfo() {
    return pipelineInfo;
  }
}