...
public class TestPipelineManager {
  ...
  @Module(injects = {PipelineManager.class, PipelineStoreTask.class, PipelineStateStore.class, StandaloneRunner.class},
    library = true)
  public static class TestPipelineManagerModule {
    ...
    public RuntimeInfo providesRuntimeInfo() {
      return new RuntimeInfo(RuntimeModule.SDC_PROPERTY_PREFIX, new MetricRegistry(),
        Arrays.asList(TestPipelineManager.class.getClassLoader()));
    }

    @Provides @Singleton
    public Configuration provideConfiguration() {
      Configuration configuration = new Configuration();
      configuration.set(PipelineManager.RUNNER_EXPIRY_INTERVAL, expiry);
