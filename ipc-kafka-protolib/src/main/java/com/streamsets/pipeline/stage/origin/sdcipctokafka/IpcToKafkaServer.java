...
public class IpcToKafkaServer {
  ...
  public IpcToKafkaServer(Stage.Context context, Configs configs, BlockingQueue<Exception> errorQueue) {
  ...
  public void start() throws Exception {
    ...
    servlet = new IpcToKafkaServlet(context, configs, errorQueue);
