...
public class TestKafkaUtil {
  ...
  public static void setUp() {
    ...
    sdcKafkaValidationUtil = new KafkaValidationUtil08();
  }
  ...
  public void testFetchTopicMetaData() throws Exception {
    ...
    Assert.assertEquals(1, sdcKafkaValidationUtil.getPartitionCount("localhost:" + port, "testFetchTopicMetaData", 3, 1000));
  ...
  public void testFetchTopicMetaDataAutoCreateFalse() throws Exception {
    ...
    try {
      sdcKafkaValidationUtil.getPartitionCount("localhost:" + port, "testFetchTopicMetaDataAutoCreateFalse", 3, 1000);
  ...
  public void testValidateZkConnectString() {
    ...
    List<KafkaBroker> kafkaBrokers = sdcKafkaValidationUtil.validateZkConnectionString(issues, "localhost:2181", "KAFKA",
    ...
    kafkaBrokers = sdcKafkaValidationUtil.validateZkConnectionString(issues, "localhost1:2181,localhost2:2181", "KAFKA",
      "zookeeperConnect", ctx);
    Mockito.verifyZeroInteractions(ctx);
    ...
    kafkaBrokers = sdcKafkaValidationUtil.validateZkConnectionString(issues, "localhost1:2181,localhost2:2181/kafka", "KAFKA",
      "zookeeperConnect", ctx);
    Mockito.verifyZeroInteractions(ctx);
    Assert.assertTrue(kafkaBrokers.size() == 2);
    Assert.assertEquals(kafkaBrokers.get(0).getHost(), "localhost1");
    ...
    kafkaBrokers = sdcKafkaValidationUtil.validateZkConnectionString(issues, "localhost:2181/kafka", "KAFKA",
      "zookeeperConnect", ctx);
    Mockito.verifyZeroInteractions(ctx);
    Assert.assertEquals(kafkaBrokers.get(0).getHost(), "localhost");
    Assert.assertEquals(kafkaBrokers.get(0).getPort(), 2181);

    kafkaBrokers = sdcKafkaValidationUtil.validateZkConnectionString(issues, "localhost1:2181/kafka,localhost2:2181/kafka", "KAFKA",
      "zookeeperConnect", ctx);
    ...
    kafkaBrokers = sdcKafkaValidationUtil.validateZkConnectionString(issues, "localhost:2181/", "KAFKA",
      "zookeeperConnect", ctx);
    Mockito.verifyZeroInteractions(ctx);
    Assert.assertEquals(kafkaBrokers.get(0).getHost(), "localhost");
    Assert.assertEquals(kafkaBrokers.get(0).getPort(), 2181);

    sdcKafkaValidationUtil.validateZkConnectionString(issues, "localhost:2181/localhost.2181/", "KAFKA",
      "zookeeperConnect", ctx);
    ...
    sdcKafkaValidationUtil.validateZkConnectionString(issues, "localhost:2181#####", "KAFKA",
      "zookeeperConnect", ctx);
    Mockito.verify(ctx, Mockito.times(2)).createConfigIssue(Mockito.anyString(), Mockito.anyString(),
      Mockito.any(ErrorCode.class), Mockito.any(), Mockito.any());

    sdcKafkaValidationUtil.validateZkConnectionString(issues, "localhost:2181:675425", "KAFKA",
      "zookeeperConnect", ctx);
    ...
    sdcKafkaValidationUtil.validateZkConnectionString(issues, "", "KAFKA", "zookeeperConnect", ctx);
    Mockito.verify(ctx, Mockito.times(1)).createConfigIssue(Mockito.anyString(), Mockito.anyString(),
      Mockito.any(ErrorCode.class), Mockito.any());

    sdcKafkaValidationUtil.validateZkConnectionString(issues, null, "KAFKA", "zookeeperConnect", ctx);
    Mockito.verify(ctx, Mockito.times(2)).createConfigIssue(Mockito.anyString(), Mockito.anyString(),
      Mockito.any(ErrorCode.class), Mockito.any());
  ...
  public void testValidateKafkaBrokerConnectString() {
    ...
    List<KafkaBroker> kafkaBrokers = sdcKafkaValidationUtil.validateKafkaBrokerConnectionString(issues, "localhost:9001", "KAFKA",
      "kafkaBroker", ctx);
    Mockito.verifyZeroInteractions(ctx);
    Assert.assertTrue(kafkaBrokers.size() == 1);
    Assert.assertEquals(kafkaBrokers.get(0).getHost(), "localhost");
    ...
    kafkaBrokers = sdcKafkaValidationUtil.validateKafkaBrokerConnectionString(issues,
    ...
    sdcKafkaValidationUtil.validateKafkaBrokerConnectionString(issues, "", "KAFKA",
      "kafkaBroker", ctx);
    Mockito.verify(ctx, Mockito.times(1)).createConfigIssue(Mockito.anyString(), Mockito.anyString(),
      Mockito.any(ErrorCode.class), Mockito.any());

    sdcKafkaValidationUtil.validateKafkaBrokerConnectionString(issues, null, "KAFKA",
      "kafkaBroker", ctx);
    Mockito.verify(ctx, Mockito.times(2)).createConfigIssue(Mockito.anyString(), Mockito.anyString(),
      Mockito.any(ErrorCode.class), Mockito.any());

    sdcKafkaValidationUtil.validateKafkaBrokerConnectionString(issues, "localhost:myPort", "KAFKA",
      "kafkaBroker", ctx);
    Mockito.verify(ctx, Mockito.times(3)).createConfigIssue(Mockito.anyString(), Mockito.anyString(),
      Mockito.any(ErrorCode.class), Mockito.any());

    sdcKafkaValidationUtil.validateKafkaBrokerConnectionString(issues, "localhost:2181:jdfhdksf", "KAFKA",
      "kafkaBroker", ctx);
