...
public class Solr06TestUtilFactory extends SdcSolrTestUtilFactory {
  private final static Logger LOG = LoggerFactory.getLogger(Solr06TestUtilFactory.class);
  public Solr06TestUtilFactory() {
  }

  @Override
  public SdcSolrTestUtil create(String url) {
    try {
      return new Solr06TestUtil(url);
    } catch (Exception e) {
