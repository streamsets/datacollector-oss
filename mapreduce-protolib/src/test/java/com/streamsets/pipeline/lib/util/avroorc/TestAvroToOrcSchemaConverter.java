...
public class TestAvroToOrcSchemaConverter {

  @Test
  public void schemaConversion() throws IOException {

    Schema avroSchema1 = new Schema.Parser().parse(
        TestAvroToOrcSchemaConverter.class.getResourceAsStream("avro_schema_1.json")
    );
