...
public class TestMapRStreamsTargetUpgrader {
  ...
  @Before
  public void setUp() {
    upgrader = SelectorStageUpgrader.createTestInstanceForStageClass(MapRStreamsDTarget.class);
  ...
  public void testV3toV4() {
    ...
    String stageConfigPath = "maprStreamsTargetConfigBean.mapRStreamsTargetConfig";
