...
public class MD5UserLine extends UserLine {

  public final static String MODE = "MD5";

  public static final Pattern PATTERN = Pattern.compile(getUserLineRegex(MODE));

  public static final Hasher HASHER = (u, p) -> Hash.getMd5Hash(p);

  public MD5UserLine(String value) {
