...
public class TestSdcIpcTargetUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/SdcIpcDTarget.yaml");
