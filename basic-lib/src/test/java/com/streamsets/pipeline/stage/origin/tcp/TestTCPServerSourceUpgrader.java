...
public class TestTCPServerSourceUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/TCPServerDSource.yaml");
    upgrader = new SelectorStageUpgrader("stage", new TCPServerSourceUpgrader(), yamlResource);
