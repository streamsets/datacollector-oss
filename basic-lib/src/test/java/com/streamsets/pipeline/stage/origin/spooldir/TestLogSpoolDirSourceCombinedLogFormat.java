...
public class TestLogSpoolDirSourceCombinedLogFormat {
  ...
  private final static String LINE1 = "127.0.0.1 ss h [10/Oct/2000:13:55:36 -0700] \"GET /apache_pb.gif HTTP/1.0\" 200 " +
  ...
  private SpoolDirSource createSource() {
    return new SpoolDirSource(DataFormat.LOG, "UTF-8", 100, createTestDir(), 10, 1, "file-[0-9].log", 10, null, null,
      ...
      null, 0, LogMode.COMBINED_LOG_FORMAT, 1000, true, null, null, Collections.<RegExConfig>emptyList(), null, null, false, null);
  }
