...
public class TestAggregationProcessor {
  ...
  public void testProcessor() throws StageException {
    ProcessorRunner runner = new ProcessorRunner.Builder(AggregationDProcessor.class)
        .addConfiguration("aggregateExpression", "X")
        .addConfiguration("aggregationTitle", "Y")
        .addConfiguration("timeWindow", "{5* SECONDS}")
