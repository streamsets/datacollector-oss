...
@ConnectionDef(
    label = "SQLServer",
    type = SQLServerConnection.TYPE,
    description = "Connects to SQLServer",
    version = 1,
    upgraderDef = "upgrader/SQLServerConnectionUpgrader.yaml",
    supportedEngines = { ConnectionEngine.COLLECTOR, ConnectionEngine.TRANSFORMER }
)
@ConfigGroups(JdbcConnectionGroups.class)
public class SQLServerConnection extends AbstractJdbcConnection {

  public static final String TYPE = "STREAMSETS_SQLSERVER";
