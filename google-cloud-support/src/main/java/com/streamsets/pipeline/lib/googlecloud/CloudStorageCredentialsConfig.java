...
public class CloudStorageCredentialsConfig extends GoogleCloudCredentialsConfig {
  ...
  public GoogleCloudStorageConnection connection = new GoogleCloudStorageConnection();
