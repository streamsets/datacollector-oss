...
public class TestLiveFileReader {
  ...
  public void testMethods() throws Exception {
    ...
    LiveFileReader lfr = new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.defaultCharset(), 0, 10);
  ...
  public void testValidCharsets() throws Exception {
    Path file = createFile(Arrays.asList("Hello1\n", "Hello2\n"));
    LiveFile lf = new LiveFile(file);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("US-ASCII"), 0, 10);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("UTF-8"), 0, 10);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("GBK"), 0, 10);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("ISO-8859-1"), 0, 10);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("shift_jis"), 0, 10);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("euc-jp"), 0, 10);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("euc-kr"), 0, 10);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("koi8-r"), 0, 10);
  }
  ...
  public void testInvalidCharset1() throws Exception {
    Path file = createFile(Arrays.asList("Hello1\n", "Hello2\n"));
    LiveFile lf = new LiveFile(file);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("UTF-16"), 0, 10);
  }
  ...
  public void testInvalidCharset2() throws Exception {
    Path file = createFile(Arrays.asList("Hello1\n", "Hello2\n"));
    LiveFile lf = new LiveFile(file);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("UTF-32"), 0, 10);
  }
  ...
  public void testInvalidCharset3() throws Exception {
    Path file = createFile(Arrays.asList("Hello1\n", "Hello2\n"));
    LiveFile lf = new LiveFile(file);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.forName("IBM500"), 0, 10);
  }
  ...
  public void testInvalidOffset() throws Exception {
    ...
    LiveFile lf = new LiveFile(file);
    new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.defaultCharset(), 10, 10);
  }
  ...
  public void testOneLineReadFromExactOffsetFullLinesNoTruncate() throws Exception {
    Path file = createFile(Arrays.asList("Hello1\n", "Hello2\n"));
    LiveFile lf = new LiveFile(file);
    LiveFileReader lfr = new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.defaultCharset(), 7, 10);
  ...
  public void testMultiLineReadFromBeginningFullLinesNoTruncate() throws Exception {
    Path file = createFile(Arrays.asList("Hello1\n", "Hello2\n"));
    LiveFile lf = new LiveFile(file);
    LiveFileReader lfr = new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.defaultCharset(), 0, 20);
  ...
  public void testTruncateMultipleReads() throws Exception {
    ...
    LiveFile lf = new LiveFile(file);
    LiveFileReader lfr = new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.defaultCharset(), 0, 6);
  ...
  public void testOneLineReadFromTruncatedOffset() throws Exception {
    Path file = createFile(Arrays.asList("Hello1\n", "Hello\n"));
    LiveFile lf = new LiveFile(file);
    LiveFileReader lfr = new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.defaultCharset(), -3, 10);
  ...
  public void testCRLFLines() throws Exception {
    ...
    lfr = new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.defaultCharset(), 0, 10);
    Assert.assertTrue(lfr.hasNext());
    chunk = lfr.next(0);
    Assert.assertNotNull(chunk);
    Assert.assertFalse(chunk.isTruncated());
    ...
    lfr = new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.defaultCharset(), 0, 8);
    Assert.assertTrue(lfr.hasNext());
    chunk = lfr.next(0);
    Assert.assertNotNull(chunk);
    Assert.assertFalse(chunk.isTruncated());
    ...
    lfr = new LiveFileReader(LogRollMode.REVERSE_COUNTER, lf, Charset.defaultCharset(), 0, 7);
    Assert.assertTrue(lfr.hasNext());
    chunk = lfr.next(0);
    Assert.assertNotNull(chunk);
    Assert.assertTrue(chunk.isTruncated());
