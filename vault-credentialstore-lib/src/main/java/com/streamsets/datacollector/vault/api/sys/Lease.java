...
public class Lease extends VaultEndpoint {
  ...
  public Lease(VaultConfiguration conf, HttpTransport transport) throws VaultException {
    super(conf, transport);
  }

  public Secret renew(String leaseId) throws VaultException {
    return getSecret("/v1/sys/renew/" + leaseId, "PUT");
  }
}
