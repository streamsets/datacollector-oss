...
public class TestMySQLHikariPoolConfigBean {
  ...
  public void testMySQLUrl() {
    ...
    MySQLHikariPoolConfigBean bean = new MySQLHikariPoolConfigBean();
  ...
  @Test
  public void testMySQLUrl_disabled() {
    Stage.Context context = Mockito.mock(Stage.Context.class);
    Mockito.when(context.createConfigIssue(Mockito.any(), Mockito.any(), Mockito.any())).thenReturn(Mockito.mock(
        ConfigIssue.class));
    ...
    bean.connectionString = "jdbc:mysql://foo";
    bean.sslMode = MySQLSSLMode.DISABLED;

    Assert.assertEquals(0, bean.validateConfigs(context, issues).size());
    Assert.assertEquals(1, bean.getSslProperties().size());
    Assert.assertEquals(MySQLSSLMode.DISABLED.toString(), bean.getSslProperties().get("sslMode"));
  }
  ...
  public void testNonMySQLUrl() {
    ...
    bean.connectionString = "jdbc:anotherSQL://foo";
    bean.certificatePem = CERT;
