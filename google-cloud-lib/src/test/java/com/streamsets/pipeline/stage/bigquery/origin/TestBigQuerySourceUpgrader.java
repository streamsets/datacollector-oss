...
public class TestBigQuerySourceUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/BigQueryDSource.yaml");
    upgrader = new SelectorStageUpgrader("stage", new BigQuerySourceUpgrader(), yamlResource);
