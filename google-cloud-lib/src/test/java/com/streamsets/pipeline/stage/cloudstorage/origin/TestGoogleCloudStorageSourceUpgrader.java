...
public class TestGoogleCloudStorageSourceUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/GoogleCloudStorageDSource.yaml");
  ...
  public void testUpgradeV1ToV2() {
    ...
    String prefix = "gcsOriginConfig.credentials.";
    String newPrefix = "gcsOriginConfig.credentials.connection.";
