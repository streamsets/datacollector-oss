...
public class TestGoogleCloudStorageToErrorTargetUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/ToErrorGoogleCloudStorageDTarget.yaml");
  ...
  public void testUpgradeV2ToV3() {
    ...
    String prefix = "gcsTargetConfig.credentials.";
    String newPrefix = "gcsTargetConfig.credentials.connection.";
