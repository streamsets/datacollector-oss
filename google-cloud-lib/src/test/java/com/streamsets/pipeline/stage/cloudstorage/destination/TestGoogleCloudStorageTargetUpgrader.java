...
public class TestGoogleCloudStorageTargetUpgrader {
  ...
  @Before
  public void setUp() {
    URL yamlResource = ClassLoader.getSystemClassLoader().getResource("upgrader/GoogleCloudStorageDTarget.yaml");
