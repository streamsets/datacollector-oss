 ...
 */
package com.streamsets.pipeline.sdk.annotationsprocessor.bundle.test;
...
public class TestStageBundle extends TestPipelineAnnotationProcessorBase {
  ...
  public List<String> getClassesToProcess() {
    return Arrays.asList("com.streamsets.pipeline.sdk.annotationsprocessor.testData.TwitterSource");
  }
  ...
  public void test(List<Diagnostic<? extends JavaFileObject>> diagnostics,
    ...
    expectedStrings.add("USER_INFO.label=null");
    expectedStrings.add("OTHER.label=null");
