...
public class TestDefaultValueWithElString extends TestPipelineAnnotationProcessorBase {

  @Override
  public List<String> getClassesToProcess() {
    return Arrays.asList(
      "com.streamsets.pipeline.sdk.annotationsprocessor.testData.DefaultValueWithELString"
    );
  }
  ...
  public void test(List<Diagnostic<? extends JavaFileObject>> diagnostics, String compilerOutput, Boolean compilationResult) {
    ...
    //the contents of DefaultValueWithElString.json
    TestUtil.compareExpectedAndActualStages("DefaultValueWithElString.json");
