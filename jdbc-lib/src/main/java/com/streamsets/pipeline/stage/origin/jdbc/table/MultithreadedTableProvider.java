...
public final class MultithreadedTableProvider {
  ...
  @VisibleForTesting
  Map<String, TableContext> getTableContextMap() {
  ...
  @VisibleForTesting
  ConcurrentMap<TableContext, Integer> getMaxPartitionWithDataPerTable() {
    return maxPartitionWithDataPerTable;
  }

  @VisibleForTesting
  SortedSetMultimap<TableContext, TableRuntimeContext> getActiveRuntimeContexts() {
